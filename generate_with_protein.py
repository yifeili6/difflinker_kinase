...
# git pull && python -W ignore generate_with_protein.py --fragments ../DiffLinkerMOAD/processed/MOAD_test_frag_one.sdf --protein ../DiffLinkerMOAD/processed/proteins/1zzu_protein.pdb --model models/pocket_difflinker_fullpocket.ckpt --linker_size 6 --output result_difflinker
