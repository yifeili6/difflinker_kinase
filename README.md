...
[USE_BELOW]
git pull && python -m gen_lig_analysis --size_prefix s11 --run_analysis --turn_off_run_test # for all sdf inside s11 directory to generate FOUR pickles!
git pull && python -m gen_lig_analysis --turn_off_run_test # Concatenate all pickles!
...
[RECOMMENDED BELOW]
git pull && python -m misc_utils --kinase_names 2xa4 4rx5 3c4c 1yol 5lqf 3cs9 4ag8 3oxz 4ase 4u7z 4an2 [val/test; 5:4:2 for type I/II/III] 
```
