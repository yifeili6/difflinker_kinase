...
[USE_BELOW]
git pull && python -m gen_lig_analysis --size_prefix s11 --run_analysis # for all sdf inside s11 directory to generate FOUR pickles!
git pull && python -m gen_lig_analysis # Concatenate all pickles!
