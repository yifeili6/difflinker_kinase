...
if __name__ == '__main__':
    ...
    pred.predict_1_with_difflinker(pred.outpath_difflinker, pred.protein_path, "1ADE.pdb", "data_docking/processed_complex/Custom_frag.sdf", "models/pocket_difflinker_fullpocket_no_anchors.ckpt", "models/geom_size_gnn.ckpt", 1, 2_000)
